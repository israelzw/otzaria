  ...
  group('FuzzyMatcher Tests', () {
    group('Similarity Calculations', () {
      test('should calculate Levenshtein similarity correctly', () {
        expect(FuzzyMatcher.calculateLevenshteinSimilarity('hello', 'hello'),
            equals(1.0));
        expect(FuzzyMatcher.calculateLevenshteinSimilarity('hello', 'hallo'),
            closeTo(0.8, 0.1));
        expect(FuzzyMatcher.calculateLevenshteinSimilarity('hello', 'world'),
            lessThan(0.5));
        expect(
            FuzzyMatcher.calculateLevenshteinSimilarity('', ''), equals(1.0));
        expect(FuzzyMatcher.calculateLevenshteinSimilarity('hello', ''),
            equals(0.0));
      });

      test('should calculate Jaccard similarity correctly', () {
        expect(FuzzyMatcher.calculateJaccardSimilarity('hello', 'hello'),
            equals(1.0));
        expect(FuzzyMatcher.calculateJaccardSimilarity('hello', 'hallo'),
            greaterThan(0.1));
        expect(FuzzyMatcher.calculateJaccardSimilarity('hello', 'world'),
            lessThan(0.5));
      });

      test('should calculate Cosine similarity correctly', () {
        expect(FuzzyMatcher.calculateCosineSimilarity('hello', 'hello'),
            closeTo(1.0, 0.01));
        expect(FuzzyMatcher.calculateCosineSimilarity('hello', 'hallo'),
            greaterThan(0.2));
        expect(FuzzyMatcher.calculateCosineSimilarity('hello', 'world'),
            lessThan(0.8));
      });
    ...
    group('Fuzzy Matching', () {
      ...
      test('should respect custom thresholds', () {
        ...
        expect(lenientCandidates.length,
            greaterThanOrEqualTo(strictCandidates.length));
      });
    });
    ...
    group('Best Match Finding', () {
      test('should handle best match search', () {
        ...
        final bestMatch =
            FuzzyMatcher.findBestMatch(searchText, targetText, minScore: 0.3);
      ...
      test('should return null for very poor matches', () {
        ...
        final bestMatch =
            FuzzyMatcher.findBestMatch(searchText, targetText, minScore: 0.8);
    ...
    group('Combined Similarity', () {
      ...
      test('should respect custom weights', () {
        ...
        final levenshteinSim =
            FuzzyMatcher.calculateLevenshteinSimilarity(text1, text2);
        final jaccardSim =
            FuzzyMatcher.calculateJaccardSimilarity(text1, text2);
    ...
    group('Threshold Validation', () {
      test('should validate correct thresholds', () {
        expect(
            FuzzyMatcher.validateSimilarityThresholds(
